...
public class Menu extends ListActivity {
    ...
    String classes[]={"MainActivity","TextPlay","Email ","Camera","Data","GraphicsAct","GraphicsSurface","Sounds","Slider","Tabs","SimpleBrowser","Flipper","Sharedpref","InternalData","UsingSqllite","aaaaa"};
    @Override
